...
Give KubixAgent any PyTorch model. It will:
...
2. Create a branch (e.g., `kubix_agent/mar10-llama7b`)
...
Self-contained model definitions ship with KubixAgent (no `transformers` library needed):
...
KubixAgent integrates with [KernelBench](#),
the standard benchmark for evaluating AI-generated GPU kernels (250+ problems across 4 difficulty
levels). While most KernelBench evaluations use one-shot LLM generation, KubixAgent runs
...
Export optimized kernels to the [HuggingFace Hub](#)
